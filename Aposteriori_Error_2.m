function [post_error]=Aposteriori_Error_2(reduced_bands,reduced_eigen_vectors,Vpot,size_Pot,reduced_N, full_N)
global Brillouin;  
global Q;
global M;
...
%        end
    for band =1:M
        ...
        [YN, flg] =bicgstab(full_Bloch-bmat, Residual, 0.01); 
        error_val = YN'*(full_Bloch-amat)*YN;
